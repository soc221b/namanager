...
class TestArchieveManager():
    ...
    def test_rename(self):
        ...
        am = ArchieveManager()
        paths = helper.mkdtemps_recur(1, 1, filecount=1,
        ...
        helper.rm_paths([pair[0] for pair in pairs])
    ...
    def test_rename_file(self):
        ...
        helper.rm_paths([pair[0] for pair in file_pairs])
    ...
    def test_rename_dir(self):
        ...
        helper.rm_paths([pair[0] for pair in dir_pairs])
    ...
    def test_gen_revert_path_pairs(self):
        am = ArchieveManager()
        paths = helper.mkdtemps_recur(1, 2, file_count=1,
                                      prefix=self.TMPFILE_PREFIX)
        ...
        helper.rm_paths([pair[0] for pair in rename_path_pairs])

    def test_separate_file_dir_from_path_pair(self):
        am = ArchieveManager()
        errors = []
        dirs = helper.mkdtemps_recur(2, 1, prefix=self.TMPFILE_PREFIX)
        files = (helper.mktemps(1, prefix=self.TMPFILE_PREFIX) +
        ...
        helper.rm_paths([pair[0] for pair in path_pairs])
    ...
    def test_sort_path_pair(self):
        ...
        helper.rm_paths(expt_hrchy1_paths +
                        expt_hrchy2_paths +
                        expt_hrchy3_paths)
